...
process.MessageLogger = cms.Service("MessageLogger",
    destinations = cms.untracked.vstring('clu_info_100'),
    clu_info_100 = cms.untracked.PSet( threshold = cms.untracked.string('INFO'))
)
...
process.o1 = cms.OutputModule("PoolOutputModule",
        ...
        fileName = cms.untracked.string('simevent_CTPPS_CLU_DB_real_100.root')
        )
