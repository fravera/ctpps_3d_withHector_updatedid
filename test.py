...
process.MessageLogger = cms.Service("MessageLogger",
    destinations = cms.untracked.vstring('clu_info_297_test'),
    clu_info_297_test = cms.untracked.PSet( threshold = cms.untracked.string('INFO'))
)
...
'root://cms-xrd-global.cern.ch//store/data/Run2017B/ZeroBias/AOD/PromptReco-v1/000/297/425/00000/1CAC00AE-4F5A-E711-8EDE-02163E019C23.root'
)
#,
...
process.o1 = cms.OutputModule("PoolOutputModule",
        outputCommands = cms.untracked.vstring('drop *','keep CTPPSPixelClusteredmDetSetVector_ctppsPixelClusters_*_*'),
        fileName = cms.untracked.string('simevent_CTPPS_CLU_DB_real_297_test.root')
        )
