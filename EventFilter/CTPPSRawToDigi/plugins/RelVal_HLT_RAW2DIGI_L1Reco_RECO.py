...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:RelVal_Raw_Fake2_DATA.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('RelVal nevts:10'),
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:RelVal_Raw_Fake2_DATA_HLT_RECO.root'),
...
process.GlobalTag = GlobalTag(process.GlobalTag, 'auto:run2_data_Fake2', '')
