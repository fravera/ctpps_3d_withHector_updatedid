...
#        process.FEVTSIMEventContent,
        outputCommands = cms.untracked.vstring('keep *_*_CTPPSPixelHits_*','keep CTPPSPixelDigiedmDetSetVector_*__*','keep CTPPSPixelClusteredmDetSetVector_*__*','keep CTPPSPixelRecHitedmDetSetVector_*__*'),
        fileName = cms.untracked.string('simevent_CTPPS_DIG_CLU_REC_5000_rid__.root')
        )
